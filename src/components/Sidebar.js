...
import "./Sidebar.css";
import myAvatar from "../assets/ich.jpg";
import {
  FiHome,
  FiSearch,
  FiCompass,
...
export default function Sidebar(props) {
  ...
  const activePanel = props.activePanel; // "search" | "notifications" | null

  const handleSearch = () => {
    if (openPanel) openPanel("search");
  };
  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar__nav">
        ...
        <button
          type="button"
          className={`sidebar__item ${activePanel === "search" ? "active" : ""}`}
        ...
        <button
          type="button"
          className={`sidebar__item ${activePanel === "notifications" ? "active" : ""}`}
      ...
      <div className="sidebar__bottom">
        ...
        <NavLink to="/profile" className="sidebar__profile">
          <img className="sidebar__avatar" src={myAvatar} alt="ich" />
